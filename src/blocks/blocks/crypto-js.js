...
Blockly.Blocks["crypto_md5"] = {
  init: function () {
    this.appendValueInput("STR").setCheck(null).appendField("使用Crypto生成哈希MD5");
...
Blockly.Blocks["crypto_sha1"] = {
  init: function () {
    this.appendValueInput("STR").setCheck(null).appendField("使用Crypto哈希SHA-1");
    this.appendDummyInput("").appendField("的对象");
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_aes_encrypt"] = {
  init: function () {
    this.appendValueInput("TEXT").setCheck(null).appendField("使用Crypto AES加密");
...
Blockly.Blocks["crypto_aes_decrypt"] = {
  init: function () {
    this.appendValueInput("TEXT").setCheck(null).appendField("使用Crypto AES解密");
    this.appendValueInput("CODE").setCheck(null).appendField("密钥");
    this.setInputsInline(true);
    this.setOutput(true, "String");
    this.setColour("#5574f8");
...
Blockly.Blocks["crypto_des_encrypt"] = {
  init: function () {
    this.appendValueInput("TEXT").setCheck(null).appendField("使用Crypto DES加密");
    this.appendValueInput("CODE").setCheck(null).appendField("密钥");
    this.setInputsInline(true);
    this.setOutput(true, "String");
    this.setColour("#5574f8");
...
Blockly.Blocks["crypto_des_decrypt"] = {
  init: function () {
    this.appendValueInput("TEXT").setCheck(null).appendField("使用Crypto DES解密");
    this.appendValueInput("CODE").setCheck(null).appendField("密钥");
    this.setInputsInline(true);
    this.setOutput(true, "String");
    this.setColour("#5574f8");
...
Blockly.Blocks["crypto_hmacmd5str"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto生成 消息");
...
Blockly.Blocks["crypto_encbase64parse"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Base64解析");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_encbase64stringify"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Base64字符串化");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_enclatin1parse"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Latin1解析");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_enclatin1stringify"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Latin1字符串化");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_enchexparse"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Hex解析");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_enchexstringify"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Hex字符串化");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_encutf8parse"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Utf8解析");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_encutf8stringify"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Utf8字符串化");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_encutf16parse"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Utf16解析");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_encutf16stringify"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto编码器Utf16字符串化");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
    this.setTooltip("");
...
Blockly.Blocks["crypto_createuuid"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck("String").appendField("使用Crypto生成UUID");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#5574f8");
