import { javascriptGenerator } from "blockly/javascript";import  Blockly from "blockly";javascriptGenerator["crypto_import"] = function (block) {
  return `var CryptoJS = require("crypto-js");\n`;
};

javascriptGenerator["crypto_md5"] = function (block) {
  var value_str = javascriptGenerator.valueToCode(
    block,
    "STR",
...
javascriptGenerator["crypto_aes_encrypt"] = function (block) {
  ...
  var value_code = javascriptGenerator.valueToCode(
    block,
    "CODE",
    javascriptGenerator.ORDER_ATOMIC
  );
...
javascriptGenerator["crypto_hmacmd5str"] = function (block) {
  ...
  var value_w = javascriptGenerator.valueToCode(
    block,
    "W",
    javascriptGenerator.ORDER_ATOMIC
  );
