...
javascriptGenerator["js_base"] = function (block) {
  var value_num = javascriptGenerator.valueToCode(
    block,
    "NUM",
    javascriptGenerator.ORDER_ATOMIC
  );
...
javascriptGenerator["js_str_index"] = function (block) {
  var value_str1 = javascriptGenerator.valueToCode(
    block,
    "STR1",
    javascriptGenerator.ORDER_ATOMIC
  );
  var value_str2 = javascriptGenerator.valueToCode(
    block,
    "STR2",
    javascriptGenerator.ORDER_ATOMIC
  );
...
javascriptGenerator["js_function_run"] = function (block) {
  var value_v = javascriptGenerator.valueToCode(
    block,
    "V",
    javascriptGenerator.ORDER_ATOMIC
  );
