...
Blockly.Blocks["game_idiom_paper"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("猜成语")
      .appendField(new Blockly.FieldTextInput("字"), "1")
      .appendField(new Blockly.FieldTextInput("字"), "2")
      .appendField(new Blockly.FieldTextInput("字"), "3")
      .appendField(new Blockly.FieldTextInput("字"), "4");
    this.setColour(230);
    this.setTooltip("");
    this.setHelpUrl("");
  },
...
Blockly.JavaScript["game_count"]=function(){return ''}