...
Blockly.Blocks['ivw_defTypes'] = {
    init: function () {
        ...
        this.appendDummyInput()
            ...
            .appendField('图标')
            .appendField(new Blockly.FieldTextInput('https://waddle.coco-central.cn/static/img/logo/logo-purple.svg'), 'icon');
        // 五个参数分两行输入
        this.appendDummyInput()
            .appendField('名称')
...
// 		this.appendDummyInput()
// 			.appendField("控件图标")
// 			.appendField(new Blockly.FieldTextInput("./static/img/logo/logo-purple.svg"), "icon");
// 		this.setPreviousStatement(true, null);
// 		this.setNextStatement(true, null);
// 		this.setColour("#5574F8");
