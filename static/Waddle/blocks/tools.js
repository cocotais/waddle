...
Blockly.Blocks['tools_dict'] = {
    init: function () {
        this.appendDummyInput().appendField('字典{');
...
Blockly.Blocks['tools_dictItem'] = {
    init: function () {
        this.appendDummyInput().appendField('字典项');
        this.appendValueInput('key').appendField('键').setCheck(null);
        this.appendValueInput('value').appendField('值').setCheck(null);
...
Blockly.Blocks['tools_listItem'] = {
    init: function () {
        this.appendDummyInput().appendField('列表项');
        this.appendValueInput('value').appendField('值').setCheck(null);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
