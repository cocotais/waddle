...
Blockly.Blocks['factory_base'] = {
    ...
    init: function () {
        this.setColour(120);
        this.appendDummyInput().appendField('块名').appendField(new Blockly.FieldTextInput('block_type'), 'NAME');
        this.appendStatementInput('INPUTS').setCheck('Input').appendField('输入参数');
        ...
        this.appendValueInput('TOOLTIP').setCheck('String').appendField('工具提示');
        this.appendValueInput('HELPURL').setCheck('String').appendField('帮助链接');
        this.appendValueInput('COLOUR').setCheck('Colour').appendField('块颜色');
...
Blockly.Blocks['input_dummy'] = {
    ...
    init: function () {
        this.jsonInit({
            ...
            nextStatement: 'Input',
            colour: 210,
            tooltip: 'For adding fields on a separate row with no ' + 'connections. Alignment options (left, right, centre) ' + 'apply only to multi-line fields.',
...
Blockly.Blocks['field_static'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput('FIRST').appendField('文本').appendField(new Blockly.FieldTextInput(''), 'TEXT');
...
Blockly.Blocks['field_label_serializable'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput('FIRST').appendField('文本').appendField(new Blockly.FieldTextInput(''), 'TEXT').appendField(',').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
        this.setTooltip('Static text that serves as a label, and is saved to' + ' XML. Use only if you want to modify this label at runtime.');
        this.setHelpUrl('https://www.youtube.com/watch?v=s2_xaEvcVI0#t=88');
    },
    onchange: function () {
        fieldNameCheck(this);
...
Blockly.Blocks['field_input'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('文本输入').appendField(new Blockly.FieldTextInput('default'), 'TEXT').appendField(',').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
...
Blockly.Blocks['field_number'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('数字输入').appendField(new Blockly.FieldNumber(0), 'VALUE').appendField(',').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.appendDummyInput().appendField('最小值').appendField(new Blockly.FieldNumber(-Infinity), 'MIN').appendField('最大值').appendField(new Blockly.FieldNumber(Infinity), 'MAX').appendField('精度').appendField(new Blockly.FieldNumber(0, 0), 'PRECISION');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
...
Blockly.Blocks['field_angle'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('角度输入').appendField(new Blockly.FieldAngle('90'), 'ANGLE').appendField(',').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
...
Blockly.Blocks['field_dropdown'] = {
    // Dropdown menu.
    init: function () {
        this.appendDummyInput().appendField('下拉选项').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.optionList_ = ['text', 'text', 'text'];
        this.updateShape_();
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
        this.setMutator(new Blockly.Mutator(['field_dropdown_option_text', 'field_dropdown_option_image']));
        this.setColour(160);
...
Blockly.Blocks['field_dropdown_container'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('添加选项');
...
Blockly.Blocks['field_dropdown_option_text'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('文本选项');
...
Blockly.Blocks['field_dropdown_option_image'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('图片选项');
        this.setPreviousStatement(true);
        this.setNextStatement(true);
...
Blockly.Blocks['field_checkbox'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('复选框').appendField(new Blockly.FieldCheckbox('TRUE'), 'CHECKED').appendField(',').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
...
Blockly.Blocks['field_colour'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('颜色输入').appendField(new Blockly.FieldColour('#ff0000'), 'COLOUR').appendField(',').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
...
Blockly.Blocks['field_variable'] = {
    ...
    init: function () {
        this.setColour(160);
        this.appendDummyInput().appendField('变量').appendField(new Blockly.FieldTextInput('item'), 'TEXT').appendField(',').appendField(new Blockly.FieldTextInput('NAME'), 'FIELDNAME');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
...
Blockly.Blocks['field_image'] = {
    ...
    init: function () {
        this.setColour(160);
        var src = 'https://www.gstatic.com/codesite/ph/images/star_on.gif';
        this.appendDummyInput().appendField('图片').appendField(new Blockly.FieldTextInput(src), 'SRC');
        this.appendDummyInput().appendField('宽').appendField(new Blockly.FieldNumber('15', 0, NaN, 1), 'WIDTH').appendField('高').appendField(new Blockly.FieldNumber('15', 0, NaN, 1), 'HEIGHT').appendField('alt text').appendField(new Blockly.FieldTextInput('*'), 'ALT').appendField('flip RTL').appendField(new Blockly.FieldCheckbox('false'), 'FLIP_RTL');
        this.setPreviousStatement(true, 'Field');
        this.setNextStatement(true, 'Field');
...
Blockly.Blocks['colour_hue'] = {
    ...
    init: function () {
        this.appendDummyInput().appendField('hue颜色:').appendField(new Blockly.FieldAngle('0', this.validator), 'HUE');
...
function fieldNameCheck(referenceBlock) {
    ...
    for (var i = 0, block; (block = blocks[i]); i++) {
        ...
        if (!block.disabled && !block.getInheritedDisabled() && otherName && otherName.toLowerCase() === name) {
            count++;
        }
    }
