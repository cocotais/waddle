...
(function (root, factory) {
	...
	module$contents$Blockly$JavaScript_JavaScript.ORDER_OVERRIDES = [
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_FUNCTION_CALL, module$contents$Blockly$JavaScript_JavaScript.ORDER_MEMBER],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_FUNCTION_CALL, module$contents$Blockly$JavaScript_JavaScript.ORDER_FUNCTION_CALL],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_MEMBER, module$contents$Blockly$JavaScript_JavaScript.ORDER_MEMBER],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_MEMBER, module$contents$Blockly$JavaScript_JavaScript.ORDER_FUNCTION_CALL],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_NOT, module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_NOT],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_MULTIPLICATION, module$contents$Blockly$JavaScript_JavaScript.ORDER_MULTIPLICATION],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_ADDITION, module$contents$Blockly$JavaScript_JavaScript.ORDER_ADDITION],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_AND, module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_AND],
		[module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_OR, module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_OR]
	];
	...
	module$contents$Blockly$JavaScript_JavaScript.getAdjusted = function (a, b, c, d, e) {
		...
		var f = a.workspace.options.oneBasedIndex ? '1' : '0',
			g = e;
		if (0 < c) var h = (g = this.ORDER_ADDITION);
		else 0 > c ? (h = g = this.ORDER_SUBTRACTION) : d && (h = g = this.ORDER_UNARY_NEGATION);
	...
	$.Blockly.JavaScript.text_getSubstring = function (a) {
		...
		if (e.match(/^'?\w+'?$/) || d) {
			...
			var f = { FIRST: 'First', LAST: 'Last', FROM_START: 'FromStart', FROM_END: 'FromEnd' };
	...
	$.Blockly.JavaScript.math_arithmetic = function (a) {
		var b = { ADD: [' + ', $.Blockly.JavaScript.ORDER_ADDITION], MINUS: [' - ', $.Blockly.JavaScript.ORDER_SUBTRACTION], MULTIPLY: [' * ', $.Blockly.JavaScript.ORDER_MULTIPLICATION], DIVIDE: [' / ', $.Blockly.JavaScript.ORDER_DIVISION], POWER: [null, $.Blockly.JavaScript.ORDER_NONE] }[a.getFieldValue('OP')],
			c = b[0];
		b = b[1];
