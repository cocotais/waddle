...
Blockly.JavaScript["js_json_parse"] = function(block){
    var text = Blockly.JavaScript.valueToCode(block, 'TEXT', Blockly.JavaScript.ORDER_ADDITION) || '""';
    var code = `JSON.parse(${text})`;
    return [code,Blockly.JavaScript.ORDER_NONE];
}

Blockly.JavaScript["js_json_stringify"] = function(block){
    var text = Blockly.JavaScript.valueToCode(block, 'OBJECT', Blockly.JavaScript.ORDER_ADDITION) || '""';
    var code = `JSON.stringify(${text})`;
    return [code,Blockly.JavaScript.ORDER_NONE];
}

Blockly.JavaScript["js_json_access"] = function(block){
    var key = Blockly.JavaScript.valueToCode(block, 'KEY', Blockly.JavaScript.ORDER_ADDITION) || '""';
    var object = Blockly.JavaScript.valueToCode(block, 'OBJECT', Blockly.JavaScript.ORDER_ADDITION) || '{}';
    var code = `${object}[${key}]`
    return code;
}