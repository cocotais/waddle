...
Blockly.Blocks['js_replace'] = {
    init: function () {
        ...
        this.appendValueInput('STR').setCheck('String').setAlign(Blockly.ALIGN_CENTRE).appendField('原字符串');
        this.appendValueInput('STR1').setCheck('String').setAlign(Blockly.ALIGN_CENTRE).appendField('要替换字符串');
        this.appendValueInput('STR2').setCheck('String').setAlign(Blockly.ALIGN_CENTRE).appendField('替换替换为');
        this.setInputsInline(true);
        this.setOutput(true, 'String');
        this.setColour('#66ccff');
