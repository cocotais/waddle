...
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] = "警告：这个积木只能在循环内使用。";
...
Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] = "如果值为真，则执行第一积木语句。否则，则执行第二积木语句。";
...
Blockly.Msg["DELETE_ALL_BLOCKS"] = "删除所有积木吗？（%1块）";
Blockly.Msg["DELETE_BLOCK"] = "删除积木块";
Blockly.Msg["DELETE_VARIABLE"] = "删除变量“%1”";
Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] = "要删除对变量“%2”的%1个引用吗？";
Blockly.Msg["DELETE_X_BLOCKS"] = "删除积木块（%1块）";
...
Blockly.Msg["MATH_SINGLE_HELPURL"] = "https://zh.wikipedia.org/wiki/算数平方根";
Blockly.Msg["MATH_SINGLE_OP_ABSOLUTE"] = "绝对值";
Blockly.Msg["MATH_SINGLE_OP_ROOT"] = "算数平方根";
...
Blockly.Msg["MATH_SINGLE_TOOLTIP_ROOT"] = "返回一个数的算数平方根。";
...
Blockly.Msg["NEW_VARIABLE_TITLE"] = "新建变量";
...
Blockly.Msg["PROCEDURES_IFRETURN_WARNING"] = "警告：这个积木只能在函数内部使用。";
...
Blockly.Msg["LISTS_CREATE_WITH_ITEM_TITLE"] = "键值对";
